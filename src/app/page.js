...
export default function Home() {
  ...
  return (
    ...
    <main className="flex-grow container mx-auto px-4 py-12">
        ...
        >
          {[
            { icon: CheckCircle, title: "Stay Organized", description: "Keep all your tasks in one place" },
            { icon: List, title: "Prioritize", description: "Focus on what matters most" },
            { icon: Clock, title: "Never Miss a Deadline", description: "Set reminders for important tasks" },
            { icon: Share2, title: "Collaborate", description: "Share lists with friends and colleagues" },
          ].map((feature, index) => (
